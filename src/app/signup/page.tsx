...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ type: 'error', message: 'Failed to sign up. Please try again.' });
    } finally {
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-6 col-md-8 col-sm-10">
                ...
                >
                  <h3 style={{ fontWeight: '700', marginBottom: '10px', color: '#111827' }} className="text-center">Create Account</h3>
                  <p className="text-center" style={{ color: '#6b7280', marginBottom: '30px' }}>
                    Join ZoroBoost to access premium Discord services.
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="contact-form">
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="form-group" style={{ marginBottom: '20px' }}>
                          <label style={{ fontWeight: '600', color: '#374151', display: 'block', marginBottom: '8px' }}>Username / Name</label>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div className="form-group" style={{ marginBottom: '20px' }}>
                          <label style={{ fontWeight: '600', color: '#374151', display: 'block', marginBottom: '8px' }}>Confirm Password</label>
                          <div style={{ position: 'relative' }}>
                            <span style={{ position: 'absolute', left: '15px', top: '50%', transform: 'translateY(-50%)', color: '#9ca3af' }}>
                              <i className="fas fa-lock"></i>
                            </span>
                    ...
                    <div className="row" style={{ marginBottom: '20px' }}>
                      <div className="col-lg-12">
                        <label style={{ color: '#4b5563', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                          ...
                          /> I agree to the <Link href="/terms-and-conditions" style={{ color: '#3b82f6' }}>Terms &amp; Conditions</Link>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        ...
                        >
                          {isSubmitting ? (
                            <>
                              <i className="fas fa-spinner fa-spin" style={{ marginRight: '8px' }}></i> Registering...
                            </>
                          ) : (
                            <>
                              Register Now <i className="fas fa-arrow-right" style={{ marginLeft: '8px' }}></i>
                            </>
                          )}
                        </button>
                      </div>
                  ...
                  <div className="text-center" style={{ marginTop: '25px', color: '#4b5563' }}>
                    Already have an account? <Link href="/login" style={{ color: '#3b82f6', fontWeight: '600' }}>Sign In</Link>
                  </div>
                </div>
              </div>
            </div>
