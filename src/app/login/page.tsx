        ...
        <div className="w-full max-w-[480px] relative z-10 px-4">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-[#B5BAC1] text-[15px]">Sign in to your ZoroBoost account.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="contact-form">
              ...
              <div className="relative flex items-center mb-6">
                ...
                <span className="flex-shrink-0 mx-4 text-[#B5BAC1] text-[11px] font-bold uppercase tracking-wide">Or email sign in</span>
                <div className="flex-grow border-t border-[#1E1F22]"></div>
              </div>
              ...
              <div className="flex justify-between items-center w-full mb-6 text-[13px]">
                <label className="text-[#B5BAC1] cursor-pointer flex items-center gap-2 m-0 hover:text-[#DBDEE1] transition-colors">
                  <input type="checkbox" className="cursor-pointer accent-[#5865F2] w-4 h-4 rounded-[3px] border-[#1E1F22] bg-[#1E1F22]" /> Remember me
                </label>
            ...
            <div className="mt-6 text-[#B5BAC1] text-[13px] text-center">
              Need an account? <Link href="/signup" className="text-[#00A8FC] hover:underline font-medium">Register</Link>
            </div>
          </div>
        </div>
      </div>
